...
def estConnect() -> None:
    """
    Establish the connection with the MySQL server at 100.71.188.19
    :rtype: None
    """
    try:
        global_.conn = sql.connect(host="100.71.188.19", user=global_.username, password=global_.password)
